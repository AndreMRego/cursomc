...
import com.andrerego.cursomc.domain.PagamentoComBoleto;
import com.andrerego.cursomc.domain.PagamentoComCartao;
import com.andrerego.cursomc.domain.Pedido;
import com.andrerego.cursomc.domain.Produto;
import com.andrerego.cursomc.domain.enums.EstadoPagamento;
import com.andrerego.cursomc.domain.enums.Perfil;
...
import com.andrerego.cursomc.repositories.ClienteRepository;
import com.andrerego.cursomc.repositories.EnderecoRepository;
import com.andrerego.cursomc.repositories.EstadoRepository;
import com.andrerego.cursomc.repositories.ItemPedidoRepository;
import com.andrerego.cursomc.repositories.PagamentoRepository;
import com.andrerego.cursomc.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRespository.saveAll(java.util.Arrays.asList(cat1, cat2,cat3,cat4,cat5,cat6,cat7));
		produtoRepository.saveAll(java.util.Arrays.asList(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11));
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","andremregodev@gmail.com","36378912377",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null,"Ana Costa","andre129@gmail.com","24283721069",TipoCliente.PESSOAFISICA,pe.encode("123"));
